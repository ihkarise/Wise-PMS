...
EXPECTED = """\
TABLES: attachments,audit_logs,consultations,patient_cases,patients,permissions,prescription_items,role_permissions,roles,schema_version,settings,sqlite_sequence,user_roles,users,visits
INDEXES: idx_attach_patient,idx_case_patient,idx_consultation_patient,idx_consultation_visit,idx_patient_name,idx_patient_phone,idx_patient_place,idx_patient_regno,idx_user_roles_user,idx_visit_case,idx_visit_date,idx_visit_patient
